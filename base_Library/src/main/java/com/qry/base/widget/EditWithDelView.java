...
/**
 * @ ClassName：EditWithDelView
 * @ Author：RonQian
 * @ Created by：2018/5/29 9:18
 * @ UpdataTime：2018/5/29 9:18
 * 带删除的输入框
 */

public class EditWithDelView extends AppCompatEditText {
    ...
    private void init() {
        ...
        imgAble = resources.getDrawable(R.mipmap.icon_edit_delete);
//        imgAble = ResUtils.getDrawable(R.drawable.icon_edit_delete);

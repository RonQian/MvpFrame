...
import com.qry.base.util.UiUtils;
 ...
 * author：RonQian
 * created by：2018/12/7 13:43
 * update by：2018/12/7 13:43
 * 用途： 多图显示
 * 修改备注：  暂时未使用 2018 12 08 glide被注释掉
 */
public class MultiImageView extends LinearLayout {
    ...
    private int pxMoreWandH = 120;// 多张图的宽高
...
//            }
            L.d("qian", "pxMoreWandH=" + pxMoreWandH + '\n' + "MAX_WIDTH=" + MAX_WIDTH + '\n' + "pxImagePadding=" + pxImagePadding);
